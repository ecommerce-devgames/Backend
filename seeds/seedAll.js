...
Platform.bulkCreate([
  ...
  { name: "Game Gear" },
  { name: "Neo Geo" },
]).then(() => console.log("Platforms Done"));

Developer.bulkCreate([
  { name: "Rockstar North" },
  { name: "Rockstar Games" },
  { name: "Valve Software" },
...
]).then(() => console.log("Developers Done"));
  ...
  [
    ...
    },
    {
      ...
      /* platforms: [
          ...
          genres: [{ name: "Action" }, { name: "Shooter" }],
          tags: [],
          developers: [{ name: "Valve Software" }, { name: "Turtle Rock Studios" }], */
      description:
    ...
    },
    {
      ...
      /*  platforms: [
          ...
          tags: [],
          developers: [{ name: "Bethesda Softworks" }], */
      description:
    ...
    },
    {
      ...
      /* platforms: [
          ...
          tags: [],
          developers: [{ name: "Double Eleven" }, { name: "Playdead" }], */
      description:
    ...
    },
    {
      ...
      /* platforms: [
          ...
          tags: [],
          developers: [{ name: "Bungie" }, { name: "Vicarious Visions" }], */
      description:
    ...
    },
    {
      ...
      rating: 3.67,
      playtime: 9,
      /*  platforms: [{ name: "PC" }, { name: "macOS" }, { name: "Linux" }],
          genres: [{ name: "Action" }, { name: "Shooter" }],
          tags: [],
          developers: [{ name: "Valve Software" }], */
      description:
